...
variable "root_parent_id" {
  ...
  default     = "7f01327e-9d29-46bb-915d-c67edf4dcf4e"
...
variable "deploy_epic_prod_landing_zones" {
  type        = bool
...
variable "deploy_finance_prod_landing_zones" {
  type        = bool
  description = "If set to true, module will deploy the \"finance\" Prod Management Group, including \"out of the box\" policies and roles."
  default     = true
}
variable "deploy_citrix_prod_landing_zones" {
  type        = bool
  description = "If set to true, module will deploy the \"citrix\" Prod Management Group, including \"out of the box\" policies and roles."
  default     = true
}
variable "deploy_business_prod_landing_zones" {
  type        = bool
...
variable "deploy_epic_test_landing_zones" {
  type        = bool
...
variable "deploy_finance_test_landing_zones" {
  type        = bool
  description = "If set to true, module will deploy the \"finance\" test Management Group, including \"out of the box\" policies and roles."
  default     = true
}
variable "deploy_citrix_test_landing_zones" {
  type        = bool
  description = "If set to true, module will deploy the \"citrix\" test Management Group, including \"out of the box\" policies and roles."
  default     = true
}
variable "deploy_business_test_landing_zones" {
  type        = bool
  description = "If set to true, module will deploy the \"business\" test Management Group, including \"out of the box\" policies and roles."
  default     = true
}
